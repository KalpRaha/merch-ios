...
struct AppURLs {
    ...
    static let ORDERS_LIST = "https://qa-api-ci.quickvee.us/orders/order_list"
    static let ORDER_DETAILS = "https://qa-api-ci.quickvee.us/orders/order_details"
    static let ORDERS_STATUS = "https://qa-api-ci.quickvee.us/orders/change_order_status"
    static let NEW_ORDERS_COUNT = "https://qa-api-ci.quickvee.us/orders/new_order_count"
    
    static let ORDER_ITEM_REFUND = "https://qa-api-ci.quickvee.us/orders/save_line_item_refund"
    static let FILTER_CATEGORY = "https://qa-api-ci.quickvee.us/Categoryapi/category_list"
    static let ITEMWISE_SALE = "https://qa-api-ci.quickvee.us/Report_api/itemwise_sale"
    static let ORDERTYPE_SALE = "https://qa-api-ci.quickvee.us/Report_api/order_type"
    static let SALES_OVERVIEW = "https://qa-api-ci.quickvee.us/Report_api/new_sale_overview"
    static let TAXES_SALE = "https://qa-api-ci.quickvee.us/Report_api/taxes"
    static let HOME_ALL_DATA = "https://qa-api-ci.quickvee.us/Dashboard/allData"
    static let ALL_STORES = "https://qa-api-ci.quickvee.us/app/all_stores"
    
    static let LOGIN = "https://qa-api-ci.quickvee.us/App/new_login_via_storename"
    static let FORGOT_PASSWORD = "https://qa-api-ci.quickvee.us/app/forgot_password"
    
    static let REGISTER = "https://qa-api-ci.quickvee.us/app/register_merchant"
    
    static let UPDATE_BUSINESS_HOURS = "https://qa-api-ci.quickvee.us/Settingapi/update_business_hours"
    static let GET_BUSINESS_HOURS = "https://qa-api-ci.quickvee.us/Settingapi/get_business_hours"
    
    static let EDIT_COUPON = "https://qa-api-ci.quickvee.us/Couponapi/edit_coupon"
    static let ADD_COUPON = "https://qa-api-ci.quickvee.us/Couponapi/add_coupon"
    static let GET_COUPON_DETAILS = "https://qa-api-ci.quickvee.us/Couponapi/get_coupon_details"
    static let COUPON_SHOW_ONLINE = "https://qa-api-ci.quickvee.us/Couponapi/show_online"
    static let COUPON_DELETE = "https://qa-api-ci.quickvee.us/Couponapi/delete_coupon"
    
    static let ADD_EDIT_VENDOR = "https://qa-api-ci.quickvee.us/app/add_edit_vendor"
    static let VENDOR_PAYMENT_LIST = "https://qa-api-ci.quickvee.us/app/vendor_payment_list"
    static let VENDOR_BY_ID = "https://qa-api-ci.quickvee.us/app/get_vendorById"
    static let VENDOR_PAYMENT_DETAILS = "https://qa-api-ci.quickvee.us/app/vendor_payment_report"
    
    static let CHANGE_PASSWORD = "https://qa-api-ci.quickvee.us/profile/change_password"
    
    static let TAX_LIST = "https://qa-api-ci.quickvee.us/Settingapi/tax_list"
    static let ADD_TAX = "https://qa-api-ci.quickvee.us/Settingapi/addnewtax"
    static let DELETE_TAX = "https://qa-api-ci.quickvee.us/Settingapi/deletetax"
    
    static let UPDATE_STORE_ALERTS = "https://qa-api-ci.quickvee.us/Settingapi/update_store_alerts"
    
    static let PROFILE = "https://qa-api-ci.quickvee.us/profile"
    static let UPDATE_PROFILE = "https://qa-api-ci.quickvee.us/profile/update_profile"
    static let LOGOUT = "https://qa-api-ci.quickvee.us/App/logout"
    
    static let STORE_DETAILS = "https://qa-api-ci.quickvee.us/Settingapi/store_details"
    static let STORE_LOGO = "https://qa-api-ci.quickvee.us/upload/"
    static let STORE_BANNER = "https://qa-api-ci.quickvee.us/upload/banner/"
    
    static let UPDATE_STORE_OPTIONS = "https://qa-api-ci.quickvee.us/Settingapi/update_store_option"
    static let UPDATE_STORE_SETUP = "https://qa-api-ci.quickvee.us/Settingapi/update_store_setup"
    
    static let INVENTORY_CATEGORY_LIST = "https://qa-api-ci.quickvee.us/Categoryapi/category_list"
    static let INVENTORY_ADD_CATEGORY = "https://qa-api-ci.quickvee.us/Categoryapi/add_category"
    static let INVENTORY_EDIT_CATEGORY = "https://qa-api-ci.quickvee.us/Categoryapi/"
    static let INVENTORY_DELETE_CATEGORY = "https://qa-api-ci.quickvee.us/Categoryapi/delete_category"
    static let INVENTORY_CATEGORY_BY_ID = "https://qa-api-ci.quickvee.us/Categoryapi/get_categoryById"
    
    static let INVENTORY_PRODUCT_LIST = "https://qa-api-ci.quickvee.us/Productapi/products_list"
    static let INVENTORY_PRODUCT_ADD = "https://qa-api-ci.quickvee.us/Productapi/add_product"
    static let INVENTORY_PRODUCT_DUPLICATE = "https://qa-api-ci.quickvee.us/Productapi/duplicate_product"
    static let INVENTORY_PRODUCT_EDIT = "https://qa-api-ci.quickvee.us/Productapi/edit_produt"
    static let INVENTORY_PRODUCT_BY_ID = "https://qa-api-ci.quickvee.us/Productapi/get_productdata_ById"
    static let INVENTORY_UPDATE_STATUS = "https://qa-api-ci.quickvee.us/Productapi/product_show_status_update"
    static let INVENTORY_PRODUCT_DELETE = "https://qa-api-ci.quickvee.us/Productapi/delete_product"
    
    static let INVENTORY_ATTRIBUTE_LIST = "https://qa-api-ci.quickvee.us/Varientsapi/varients_list"
    static let INVENTORY_ADD_ATTRIBUTE = "https://qa-api-ci.quickvee.us/Varientsapi/add_varient"
    
    static let INVENTORY_VARIANT_LIST = "https://qa-api-ci.quickvee.us/productapi/variant_list"
    static let INVENTORY_UPDATE_PRODUCT_VARIANT = "https://qa-api-ci.quickvee.us/productapi/update_product_variant"
    static let INVENTORY_VARIANT_BY_ID = "https://qa-api-ci.quickvee.us/productapi/get_variantdata_ById"
    static let INVENTORY_VARIANT_UPDATE = "https://qa-api-ci.quickvee.us/productapi/update_product_variant"
    static let INVENTORY_SAVE_INSTANT_PO = "https://qa-api-ci.quickvee.us/productapi/save_instant_po"
    
    static let INVENTORY_SETTINGS  = "https://qa-api-ci.quickvee.us/Profile_setup/inventory_register_setting"
    static let INVENTORY_SYNC_DATA  = "https://qa-api-ci.quickvee.us/App/sync_app"
    static let PASSCODE_LOGIN = "https://qa-api-ci.quickvee.us/App/employee_list"
    static let INVENTORY_PASSCODE = "https://qa-api-ci.quickvee.us/productapi/"
    
    static let SALES_HISTORY = "https://qa-api-ci.quickvee.us/productapi/saleshistory"
    
    static let ADD_BULK_PRICING = "https://qa-api-ci.quickvee.us/Productapi/add_bulk_pricing"
    static let GET_BULK_PRICING = "https://qa-api-ci.quickvee.us/productapi/get_bulk_pricing_ById"
    static let DELETE_BULK_PRICING = "https://qa-api-ci.quickvee.us/productapi/delete_bulk_pricing"
    static let UPDATE_BULK_PRICING = "https://qa-api-ci.quickvee.us/productapi/edit_bulk_pricing"
    
    static let ADD_PURCHASE_QUANTITY = "https://qa-api-ci.quickvee.us/Productapi/update_purchase_qty"
    
    static let FCM_TOKEN = "https://qa-api-ci.quickvee.us/App/save_fcm_token/1"
    
    static let LOYALTY_LIST = "https://qa-api-ci.quickvee.us/Loyalty_program_api/loyalty_program_list"
    static let UPDATE_LOYALTY_PROGRAM = "https://qa-api-ci.quickvee.us/Loyalty_program_api/save_loyalty_program"
    
    static let BONUS_BY_ID = "https://qa-api-ci.quickvee.us/Loyalty_program_api/bouns_point_promotions_list"
    static let BONUS_UPDATE = "https://qa-api-ci.quickvee.us/Loyalty_program_api/add_bouns_point_promotions"
    static let DELETE_BONUS = "https://qa-api-ci.quickvee.us/Loyalty_program_api/delete_loyalty_program"
    
    static let SET_REGISTER_SETTINGS = "https://qa-api-ci.quickvee.us/Profile_setup/inventory_register_setting"
    static let UPDATE_REGISTER_SETTINGS = "https://qa-api-ci.quickvee.us/Profile_setup/register_setting"
    
    static let UPDATE_SYSTEM_ACCESS = "https://qa-api-ci.quickvee.us/Profile_setup/system_access"
    static let CHECK_END_SHIFT = "https://qa-api-ci.quickvee.us/Shift_inout/check_eod"
    
    static let EMPLOYEE_LIST = "https://qa-api-ci.quickvee.us/App/employee_list"
    static let EMPLOYEE_BY_ID = "https://qa-api-ci.quickvee.us/App/getEmployeeByEmpid"
    static let ADD_EMPLOYEE = "https://qa-api-ci.quickvee.us/App/addEdit_employee"
    static let DELETE_EMPLOYEE = "https://qa-api-ci.quickvee.us/App/delete_employee"
    
    static let SETUP_INVENTORY = "https://qa-api-ci.quickvee.us/Profile_setup/inventory_register_setting"
    static let UPDATE_SETUP_INVENTORY = "https://qa-api-ci.quickvee.us/Profile_setup/inventory_setting"
    
    static let ADD_BRANDS_TAGS = "https://qa-api-ci.quickvee.us/Productapi/add_brand_tag"
    static let UPDATE_BRANDS_TAGS = "https://qa-api-ci.quickvee.us/Productapi/update_brand_tag"
    static let GET_BRANDS_TAGS = "https://qa-api-ci.quickvee.us/Productapi/list_brand_tag"
    static let DELETE_BRANDS_TAGS = "https://qa-api-ci.quickvee.us/Productapi/delete_brand_tag"
    
    static let MIX_N_MATCH_PRICING_LIST = "https://qa-api-ci.quickvee.us/Mix_match_pricing_api/mix_match_pricing_list"
    static let ADD_MIX_N_MATCH_PRICING = "https://qa-api-ci.quickvee.us/Mix_match_pricing_api/add_mix_match_pricing"
    static let DELETE_MIX_N_MATCH_PRICING = "https://qa-api-ci.quickvee.us/Mix_match_pricing_api/delete_mix_match_pricing"
    static let ENABLE_MIX_N_MATCH_PRICING = "https://qa-api-ci.quickvee.us/Mix_match_pricing_api/enable_mix_match_pricing"
    
    
    static let GIFT_CARD_LIST = "https://qa-api-ci.quickvee.us/Gift_Ebt_api/get_giftcard"
    static let GIFT_CARD_ADD_REMOVE = "https://qa-api-ci.quickvee.us/Gift_Ebt_api/adjust_giftcard"
    
    static let CUSTOMERS_LIST = "https://qa-api-ci.quickvee.us/Customer_merchant_api/new_customer_list"
    static let CUSTOMERS_PAID_REFUND_MERCHANT_LIST = "https://qa-api-ci.quickvee.us/Customer_merchant_api/new_mrtwise_customer_list_api"
    static let FIND_CUSTOMER = "https://qa-api-ci.quickvee.us/App/find_customer"
    
    static let DELETE_CUSTOMERS = "https://qa-api-ci.quickvee.us/Customer_merchant_api/delete_customer"
    static let DISABLE_CUSTOMERS = "https://qa-api-ci.quickvee.us/Customer_merchant_api/disable_customer"
    static let ADD_CUSTOMERS = "https://qa-api-ci.quickvee.us/App/save_customer_details"
    static let CUSTOMERS_ADD_REMOVE_LOYALTY_POINTS = "https://qa-api-ci.quickvee.us/Loyalty_program_api/loyality_point_transaction"
    static let LOYALTY_PROGRAM_LIST = "https://qa-api-ci.quickvee.us/Loyalty_program_api/loyalty_program_list"
    
    static let STOCKTAKE_LIST = "https://qa-api-ci.quickvee.us/Stocktake_api/stocktake_list"
    static let STOCK_BY_ID = "https://qa-api-ci.quickvee.us/Stocktake_api/get_stocktake_details_by_id"
    static let SAVE_STOCK = "https://qa-api-ci.quickvee.us/Stocktake_api/create_stocktake"
    static let STOCK_DELETE = "https://qa-api-ci.quickvee.us/Stocktake_api/delete_stocktake_item"
    static let STOCK_EMAIL = "https://qa-api-ci.quickvee.us/Purchase_orders_api/email_po"
    static let VOID_STOCK = "https://qa-api-ci.quickvee.us/Stocktake_api/void_stocktake"
    
    static let BOGO_LIST = "https://qa-api-ci.quickvee.us/Bogoapi/bogo_list"
    static let ADD_BOGO = "https://qa-api-ci.quickvee.us/Bogoapi/add_bogo"
    static let ENABLE_BOGO = "https://qa-api-ci.quickvee.us/Bogoapi/bogo_status"
    static let DELETE_BOGO = "https://qa-api-ci.quickvee.us/Bogoapi/delete_bogo"
